...
function alert($msg='',$url='',$icon='',$time=3){ 
    ...
    $str='<script type="text/javascript" src="/public/static/index/js/jquery-3.4.1.min.js"></script><script type="text/javascript" src="/public/static/admin/layer/2.4/layer.js"></script>';//加载jquery和layer
